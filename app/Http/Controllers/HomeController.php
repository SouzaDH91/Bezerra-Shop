...
class HomeController extends Controller
{
    ...
    public function submitContact(Request $request)
    {
        ...
        session()->flash('message','Mensagem de contato enviada com sucesso.');
    ...
    public function submitSubscribe(Request $request)
    {
        ...
        Subscribe::create($in);
        session()->flash('message','Obrigado por assinar nossa newsletter.');
    ...
    public function getCategoryProduct($id, $slug)
    {
        ...
        $data['page_title'] = $category->name." - Produtos";
    ...
    public function rangePrice(Request $request)
    {
        ...
        $data['page_title'] = trim($rr[0])." - ".trim($rr[1])." - Produtos";
    ...
    {
        $data['page_title'] = $request->name." - Produtos";
    ...
    public function getProductDetails($slug)
    {
        ...
        $data['relatedProduct'] = Product::whereCategory_id($product->category_id)->take(4)->get();
        $product->save();
...
//        Cart::destroy();
    ...
    {
        $titlePayment = 'Escolha o metodo de pagamento';

        return view('home.order-overview');
    }

    public function orderCompleted($oderNumber)
    {
        $data['page_title'] = 'Confirmação pedido de compra';
        $data['order'] = Order::whereOrder_number($oderNumber)->first();
        if ($data['order'] == null){
            session()->flash('message','Número do pedido inválido.');
