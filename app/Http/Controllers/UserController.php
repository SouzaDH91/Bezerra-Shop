...
class UserController extends Controller
{
    ...
    public function updateProfile(Request $request)
    {
        ...
        $date = str_replace('/', '-', $in['birth']);
        $in['birth'] = date('Y-m-d', strtotime($date));
        $user->fill($in)->save();
    ...
    public function updatePassword(Request $request)
    {
        ...
        try {
            ...
            if(Hash::check($request->old_password, $c_password)){
                ...
                session()->flash('message', 'Senha atual não encontrada');
    ...
    public function submitDetails(Request $request)
    {
        ...
        $request->validate([
           ...
           's_zip' => 'required',
           's_address' => 'required',
           's_addr_numb' => 'required',
           's_landmark' => 'required',
           'b_name' => 'required',
           'b_addr_numb' => 'required',
           'b_email' => 'required|email',
           'b_number' => 'required|numeric',
           'b_area_code' => 'required',
           'b_company' => 'required',
           'b_country' => 'required',
           'b_state' => 'required',
           'b_city' => 'required',
    ...
    public function orderSubmit(Request $request, Pagseguro $pagseguro)
    {
        if (Cart::count() == 0){
