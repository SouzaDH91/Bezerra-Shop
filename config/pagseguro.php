...
$urlSessionTransparent      = ($isSandbox) ? 'https://ws.sandbox.pagseguro.uol.com.br/v2/sessions' : 'https://ws.pagseguro.uol.com.br/v2/sessions';
...
return [
    ...
    'url_transparent_session'       => $urlSessionTransparent,
