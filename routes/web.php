...
// $this->get('pagseguro', 'HomeController@methodPayment')->name('method.payment');
...
Route::group(['prefix' => 'user'], function () {
    ...
    Route::any('pagseguro-getcode', 'PagseguroController@getCode')->name('pagseguro.code.transparent');
    Route::any('pagseguro-payment-billet', 'PagseguroController@billet')->name('pagseguro.billet');
    Route::post('pagseguro-payment-card', 'PagseguroController@paymentCard')->name('pagseguro.card');
